...
TEST(Mappers_VNColonialMapperTests, ProvincesCanBePingedforStatus)
{
	std::stringstream input;
	input << R"(link = { name = "British Pacifics" key = 290 provinces = { 2524 2508 } })";
	input << R"(link = { name = "British SEA" key = 300 provinces = { 1320 1343 1344 1345 1384 1386 1388 } })";
	...
	EXPECT_TRUE(mapper.isProvinceVNColonial(1343));
	EXPECT_FALSE(mapper.isProvinceVNColonial(1));
}
