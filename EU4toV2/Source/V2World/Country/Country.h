...
class Country
{
  public:
	...
	void setReformPosition(const std::string& reform, const std::string& position) { hpmReforms.insert(make_pair(reform, position)); }
  ...
  private:
	...
	std::map<std::string, std::string> hpmReforms;
