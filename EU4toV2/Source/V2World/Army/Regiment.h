...
static std::map<std::string, REGIMENTTYPE> RegimentNameToType{{"irregular", REGIMENTTYPE::irregular},
...
static std::map<REGIMENTTYPE, std::string> RegimentTypeToName{{REGIMENTTYPE::irregular, "irregular"},
...
class Regiment // also Ship
{
  public:
	...
	void giveName(std::shared_ptr<UnitNames> unitNames, const std::vector<std::string>& shipType);
