...
void EU4::Provinces::logTotalProvinceWeights() const
{
	...
	for (auto& province: provinces)
	{
		...
		EU4_Production << provinceStats.goodsProduced << ",";
		EU4_Production << provinceStats.price << ",";
		EU4_Production << provinceStats.tradeEfficiency << ",";
		EU4_Production << provinceStats.productionEfficiency << ",";
		EU4_Production << provinceStats.tradeValue << ",";
		EU4_Production << provinceStats.totalTradeValue << ",";
		EU4_Production << province.second->getProductionIncome() << ",\n";

		EU4_Tax << province.second->getName() << ",";
		EU4_Tax << province.second->getOwnerString() << ",";
		EU4_Tax << provinceStats.baseTax << ",";
		EU4_Tax << provinceStats.buildingsIncome << ",";
		EU4_Tax << provinceStats.taxEfficiency << ",";
		EU4_Tax << provinceStats.totalTaxIncome << ",\n";
